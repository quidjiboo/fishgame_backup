...
public class AssetsMy_old_beforfonts implements Disposable, AssetErrorListener {

	public static final String TAG = AssetsMy_old_beforfonts.class.getName();

	public static final AssetsMy_old_beforfonts instance = new AssetsMy_old_beforfonts();
	...
	private AssetsMy_old_beforfonts () {
	}
	...
	public class AssetFonts {
		...
		public AssetFonts () {
			...
			defaultSmall = new BitmapFont(Gdx.files.internal("images/my_fnt.fnt"), true);
			defaultNormal = new BitmapFont(Gdx.files.internal("images/my_fnt.fnt"), false);
			MyFont = new BitmapFont(Gdx.files.internal("images/my_fnt.fnt"), false);
			defaultBig = new BitmapFont(Gdx.files.internal("images/my_fnt.fnt"), true);
			Big = new BitmapFont(Gdx.files.internal("images/my_fnt.fnt"), true);
			// set font sizes
			defaultSmall.setScale(0.25f);
			MyFont.setScale(0.25f);
		Big.setScale(0.45f);
			defaultBig.setScale(0.25f);
			// enable linear texture filterinâàïïâg for smooth fonts
...
//			sky = atlas.findRegion("sky");
	...
	public void init (AssetManager assetManager) {
		...
		// load texture atlas
		System.out.println("Çàãðóæàþ ðèñóíêè");
...
//		TextureAtlas atlas = assetManager.get(Constants.TEXTURE_ATLAS_OBJECTS);
		// enable texture filtering for pixel smoothinëäëîgðïîðïîðïîðïîïðíåãåíã
//		for (Texture t : atlas.getTextures()) {
	...
	@Override
	public void dispose () {
		System.out.println("Óäàëèë ðèñóíêè");
