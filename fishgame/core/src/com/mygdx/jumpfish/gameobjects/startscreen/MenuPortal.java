...
public class MenuPortal extends AbstractGameObject {
...
//	animatedBox2DSprite = new AnimatedBox2DSprite(animatedSprite);
	...
	//	body.setUserData(box2DSprite);
		...
		body.getFixtureList().get(0).setFriction(100);
		body.resetMassData();
...
;
	...
	public void update(float deltaTime,boolean xx) {
		
		super.update(deltaTime);
		if (animation!=portal_open&&xx){
