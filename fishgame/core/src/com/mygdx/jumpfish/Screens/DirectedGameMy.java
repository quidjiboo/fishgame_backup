...
public abstract class DirectedGameMy implements ApplicationListener {

	private boolean init;
	private AbstractGameScreenMY currScreen;
	private AbstractGameScreenMY nextScreen;
	...
	public void setScreen (AbstractGameScreenMY screen) {
		setScreen(screen, null);
	}

	public void setScreen (AbstractGameScreenMY screen, ScreenTransition screenTransition) {
	...
	@Override
	public void dispose () {
		System.out.println("òåòñò!!!!!");
		if (currScreen != null) currScreen.hide();
		if (nextScreen != null) nextScreen.hide();
		if (init) {
			System.out.println("YUPÓÏÑÓÏÑ");
			currFbo.dispose();
			currScreen = null;
			nextFbo.dispose();
			nextScreen = null;
