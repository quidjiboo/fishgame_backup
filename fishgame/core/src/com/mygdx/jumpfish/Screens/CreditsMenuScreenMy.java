...
import com.mygdx.jumpfish.credits.CreditsWorldControllerMy;
import com.mygdx.jumpfish.credits.CreditsWorldRendererMy;
...
public class CreditsMenuScreenMy extends AbstractGameScreenMY
{
	private static final String TAG = CreditsMenuScreenMy.class.getName();
	private CreditsWorldControllerMy worldController2;

	private CreditsWorldRendererMy worldRenderer2;
	private boolean paused1;
	

	public CreditsMenuScreenMy(DirectedGameMy game) {
	...
	public void show() {
	 ...
	 worldController2 = new CreditsWorldControllerMy(game); 
			worldRenderer2 = new CreditsWorldRendererMy(worldController2);
